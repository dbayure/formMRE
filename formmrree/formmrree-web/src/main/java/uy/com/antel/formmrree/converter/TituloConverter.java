...
@FacesConverter(forClass = Titulo.class, value = "tituloConverter")
	...
	public Object getAsObject(FacesContext context, UIComponent component, String value) {
		...
		try {
			...
			titulo = mapper.readValue(new URL( context.getExternalContext().getRequestScheme() + "://" + context.getExternalContext().getRequestServerName()
					...
					+ "/rest/titulos/" + value), Titulo.class);
		}
		catch(Exception e) {
			throw new ConverterException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error de Conversion", "Titulo no válido"));
		}
		return titulo;
	}
