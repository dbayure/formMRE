...
@RequestScoped
public class NivelEducativoResourceRESTService {
   ...
   public List<NivelEducativo> listAll() {
      ...
      final List<NivelEducativo> results = em.createQuery("select c from NivelEducativo c order by c.id").getResultList();
      return results;
   }
   ...
   @Path("/{id:[0-9][0-9]*}")
   @Produces("application/json")
   public NivelEducativo lookupById(@PathParam("id") long id) {
